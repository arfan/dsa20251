...
if __name__ == "__main__":
    ...
    pairs = [(10, "ten"), (3, "three"), (17, "seventeen"), (24, "twentyfour"), (31, "thirtyone")]
    for k, v in pairs:
        h.insert(k, v)
    ...
    print("Search 17:", h.search(17))        # -> "seventeen"
    print("Search 99:", h.search(99))        # -> None

    print("Delete 17:", h.delete(17))        # -> True
    print("Delete 17 again:", h.delete(17))  # -> False

    print("Contains 24:", h.contains(24))    # -> True
    print("Length:", len(h))
    print("\nFinal table:")
    print(h)